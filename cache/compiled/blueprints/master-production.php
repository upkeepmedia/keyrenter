...
return [
    ...
    'timestamp' => 1683641661,
    'checksum' => '8acc2ed90469c6246bed69d5bd3952eb',
    'files' => [
        ...
        'user/themes' => [
            'themes/keyrenter' => [
                'file' => 'user/themes/keyrenter/blueprints.yaml',
                'modified' => 1682453725
            ],
            'themes/keyrenter2' => [
                'file' => 'user/themes/keyrenter2/blueprints.yaml',
                'modified' => 1682440963
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'themes.keyrenter.dropdown' => [
                'type' => '_parent',
                'name' => 'themes.keyrenter.dropdown',
                'form_field' => false
            ],
            'themes.keyrenter.dropdown.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.keyrenter.dropdown.enabled',
                'validation' => 'loose'
            ],
            'themes.keyrenter.production' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.keyrenter.production',
                'validation' => 'loose'
            ],
            'themes.keyrenter2' => [
                'type' => '_root',
            ...
            'themes.keyrenter2.dropdown' => [
                'type' => '_parent',
                'name' => 'themes.keyrenter2.dropdown',
                'form_field' => false
            ],
            'themes.keyrenter2.dropdown.enabled' => [
                'type' => 'toggle',
                'label' => 'Dropdown in Menu',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.keyrenter2.dropdown.enabled',
                'validation' => 'loose'
            ],
            'themes.keyrenter2.production' => [
                'type' => 'toggle',
                'label' => 'Production Mode',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.keyrenter2.production',
                'validation' => 'loose'
            ]
        ],
        'rules' => [
        ...
        'nested' => [
            ...
            'themes' => [
                'keyrenter' => [
                    'dropdown' => [
                        'enabled' => 'themes.keyrenter.dropdown.enabled'
                    ],
                    'production' => 'themes.keyrenter.production'
                ],
                'keyrenter2' => [
                    'dropdown' => [
                        'enabled' => 'themes.keyrenter2.dropdown.enabled'
                    ],
                    'production' => 'themes.keyrenter2.production'
                ]
            ]
        ],
        'dynamic' => [
